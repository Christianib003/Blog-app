...
RSpec.describe Post, type: :system do
  user = User.create(name: 'Christian', posts_counter: 0, photo: 'https://randomuser.me/api/portraits/men/70.jpg',
  ...
  describe 'tests for the posts index page' do
    ...
    it 'I can see the first comments on a post.' do
      comment = Comment.create(author_id: user.id, post_id: subject.id, text: 'Hi Christian')
      visit user_posts_path(user.id)
  ...
  describe 'tests for the posts show page' do
    it "I can see a post's title." do
      visit user_post_path(user.id, subject.id)
      page.has_content?(subject.title)
    end
